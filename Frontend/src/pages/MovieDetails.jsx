  ...
  return show ?  (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        <img src={image_base_url + show.movie.poster_path} alt="favourite" className='max-md:mx-auto rounded-xl h-104 max-w-70 object-cover' />
      ...
      <div className='overflow-x-auto no-scrolbar mt-8 pb-4'>
        <div className='flex items-center gap-4 w-max px-4'>
          {show.movie.casts.slice(0,12).map((cast, index) => (
            <div key={index} className='flex flex-col items-center text-center'>
              <img className='h-20 md:h-20 aspect-square object-cover rounded-full' src={image_base_url + cast.profile_path} alt="" />
